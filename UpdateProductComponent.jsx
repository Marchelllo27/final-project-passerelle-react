...
const AddProductPage = props => {
  ...
  const [loadedProductData, setLoadedProductData] = useState(initialValues);
  ...
  const formik = useFormik({
    initialValues: {
      ...
      weight: loadedProductData.weight,
      description: loadedProductData.description,
      type: loadedProductData.type,
      ingredients: loadedProductData.ingredients[0],
      energy: 0,
      proteins: 0,
      carbohydrates: 0,
      lipids: 0,
  ...
  if (!loadedProductData) return <p>Quelque chose s'est mal passé</p>;
};
