...
import classes from "./UpdateProductComponent.module.css";
...
const AddProductPage = props => {
  ...
  const [image, setImage] = useState(props.preloadedValues.image);
  const [type, setType] = useState(props.preloadedValues.type);
  const [isChecked, setIsChecked] = useState(
    props.preloadedValues.type && !!props.preloadedValues.type
  );
  ...
  const formik = useFormik({
    initialValues: {
      product: props.preloadedValues.product,
      name: props.preloadedValues.name,
      weight: props.preloadedValues.weight,
      description: props.preloadedValues.description,
      ingredients: props.preloadedValues.ingredients[0],
      energy: props.preloadedValues.energy || 0,
      proteins: props.preloadedValues.proteins || 0,
      carbohydrates: props.preloadedValues.carbohydrates || 0,
      lipids: props.preloadedValues.lipids || 0,
      sugar: props.preloadedValues.sugar || 0,
      dietaryFiber: props.preloadedValues.dietaryFiber || 0,
      calcium: props.preloadedValues.calcium || 0,
      iron: props.preloadedValues.iron || 0,
      magnesium: props.preloadedValues.magnesium || 0,
      zinc: props.preloadedValues.zinc || 0,
      vitaminE: props.preloadedValues.vitaminE || 0,
      vitaminK1: props.preloadedValues.vitaminK1 || 0,
      vitaminC: props.preloadedValues.vitaminC || 0,
      vitaminD: props.preloadedValues.vitaminD || 0,
      vitaminB1: props.preloadedValues.vitaminB1 || 0,
      vitaminB2: props.preloadedValues.vitaminB2 || 0,
      vitaminB3: props.preloadedValues.vitaminB3 || 0,
      vitaminB5: props.preloadedValues.vitaminB5 || 0,
      vitaminB6: props.preloadedValues.vitaminB6 || 0,
      vitaminB9: props.preloadedValues.vitaminB9 || 0,
      vitaminB12: props.preloadedValues.vitaminB12 || 0,
      price: props.preloadedValues.price,
    },
    // INPUT VALIDATION
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      switch (values.product) {
        case "dish":
          url = `/admin/products/dish/update/${props.id}`;
          break;
        case "drink":
          url = `/admin/products/drink/update/${props.id}`;
          break;
        case "dessert":
          url = `/admin/products/dessert/update/${props.id}`;
          break;
        default:
          url = `/admin/products/dish/update/${props.id}`;
      }
  ...
  return (
    <>
      ...
      <form className={classes.form} onSubmit={formik.handleSubmit}>
        <p>Modifier un produit existant!</p>
        <ImageUpload
          id="image"
          name="image"
          center
          previewUrl={`${process.env.REACT_APP_URL_API}/uploads/images/${props.imageFolder}/${props.preloadedValues.image}`}
